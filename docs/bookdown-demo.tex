...
\[\Rightarrow \rho  = \frac{\sum y_i}{n}=\frac{p}{n}\] Thus, we can get
that the \(\rho\) the maximuzes the likelihood function is equal to the
sample mean.

\section{Logit}\label{logit-1}
