...
\(lmer(y~1|groups)\) will generate the same results.
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{head}\NormalTok{(sleepstudy)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{nrow}\NormalTok{(sleepstudy)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#lmer ( Reaction ~ Days + ( Days | Subject ) , data= sleepstudy )}
\KeywordTok{lmer}\NormalTok{ ( Reaction }\OperatorTok{~}\StringTok{ }\NormalTok{Days }\OperatorTok{+}\StringTok{ }\NormalTok{( Days}\OperatorTok{|}\StringTok{ }\NormalTok{Subject ) , }\DataTypeTok{data=}\NormalTok{ sleepstudy )}
\end{Highlighting}
\end{Shaded}
