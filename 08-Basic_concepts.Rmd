...
We can use R to implement this calculation. As we can see, there is no need to do any iterations at all, but rather just pure just matrix calculation. 
...
__Side Notes__
The function of as.matrix will automatically make c(2,1,2) become the dimension of $3 \time 1$, you do not need to transpose the $\beta$. 
