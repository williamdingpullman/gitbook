...
In the example above, we are not really trying to estimate a lot of regression coefficient. What we are doing actually is to calculate the sample mean, or intercept in the regresion sense. What does it mean? Let's use some data to explain it. 
